...
internal object DataUtils {
    ...
    inline fun <reified T : Any> dataToString(info: T?): String {
            ...
            dataStr.trim().replace("\n", "").split(SPLIT_CHAR).let { lst ->
                ...
                for (i in 0 until lst.size / 2) {
                    ...
                    val field = try {
                        ...
                        logUtils.e(T::class.java.name, e.message.toString())
                        null
                    }
                    try {
                        ...
                        logUtils.e(T::class.java.name, e1.message.toString())
                    } catch (e2: IllegalArgumentException) {
                        logUtils.e(T::class.java.name, e2.message.toString())
                    }
                }
                return result
            }
